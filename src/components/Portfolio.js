...
const PortfoliosList = () => {
  const portfolios = [
    ...
    { discipline: 'Физические основы радиосвязи', name: 'хз', email: '' },
    ...
    { discipline: 'Обработка экспериментальных данных', name: 'хз', email: '' },
    { discipline: 'Безопасность жизнедеятельности', name: 'хз', email: '' },
    ...
    { discipline: 'Оптоэлектроника и нанофотоника', name: 'хз', email: '' },
  ];
